...
namespace Editor
{
	...
	public:
		...
		static bool DrawTextureControl(const std::string& label, Engine::Ref<Engine::Texture2D>& texture);
		static bool DrawMaterialControl(const std::string& label, Engine::Ref<Engine::Material>& mat);
