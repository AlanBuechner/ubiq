...
namespace glm
{
	...
	/// Math::Vector4 h;
	/// ...
	/// Math::Vector4 r = glm::mix(g, h, a); // Interpolate with a floating-point scalar two vectors.
	/// Math::Vector4 s = glm::mix(g, h, b); // Returns g or h;
	/// glm::dvec3 t = glm::mix(e, f, a); // Types of the third parameter is not required to match with the first and the second.
	/// Math::Vector4 u = glm::mix(g, h, r); // Interpolations can be perform per component with a vector for the last parameter.
	/// @endcode
