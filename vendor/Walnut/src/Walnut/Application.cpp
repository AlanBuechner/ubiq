...
namespace Walnut {
	...
	void Application::Init()
	{
		...
		ImFont* robotoFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 40.0f, &fontConfig);
		io.FontDefault = robotoFont;
		// load other fonts
		m_HeaderFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 120.0f, &fontConfig);
		m_TabButtonFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 70.0f, &fontConfig);
		m_ProjectTitleFont = io.Fonts->AddFontFromMemoryTTF((void*)g_RobotoRegular, sizeof(g_RobotoRegular), 50.0f, &fontConfig);
